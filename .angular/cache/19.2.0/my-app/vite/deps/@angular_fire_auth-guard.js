import {
  Router
} from "./chunk-HNNGHE7V.js";
import "./chunk-5LHZDAJP.js";
import "./chunk-K67C4W5X.js";
import "./chunk-KOCZOLIJ.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var mintCookieFactory = (url) => (user3) => __async(void 0, null, function* () {
  const idTokenResult2 = user3 && (yield user3.getIdTokenResult());
  const idTokenAge = idTokenResult2 && ((/* @__PURE__ */ new Date()).getTime() - Date.parse(idTokenResult2.issuedAtTime)) / 1e3;
  if (idTokenAge && idTokenAge > authIdTokenMaxAge) {
    return;
  }
  const idToken3 = idTokenResult2 === null || idTokenResult2 === void 0 ? void 0 : idTokenResult2.token;
...
var AuthGuardModule = class _AuthGuardModule {
  constructor() {
    registerVersion("angularfire", VERSION2.full, "auth-guard");
  }
